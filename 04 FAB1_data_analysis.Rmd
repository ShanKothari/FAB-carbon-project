...
Lastly, we present a result that we show in the Discussion: plots with higher aboveground biomass have lower soil moisture (and also fewer macroaggregates, although this is wrapped up into the structural equation model below).
