...
```{r readPLFAs}
PLFA<-read.table("e271_Soil lipid (P_NLFA) and AMF (spore and sequence) data from selected plots.txt",
                 sep="\t", header=T)
...
carbon_seq$X16.1_w5c.nm<-PLFA$X16.1_w5c.nm[PLFA_match]
## we attach remaining columns in an unseen code block
```
