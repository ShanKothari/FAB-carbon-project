...
The GitHub repository housing this document can be found at [this link](https://github.com/ShanKothari/FAB-carbon-project). A stable archived version can be found at Kothari et al. (2024).
...
The archived data can be found at the EDI Data Portal (Bryant et al. 2023). After setting the working directory to where we saved the data file, we can read it in.
