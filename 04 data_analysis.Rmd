...
These plots offer scant evidence that macroaggregates have much relation to soil C, accounting for the non-independence of plots from the same block. From a more basic soil science perspective, we might wish to see whether there is a correlation between soil percent C and macroaggregates across the full dataset (without the block random effect). There is, although this relationship is perhaps surprisingly weak, and (even more surprisingly) is stronger when examining percent C in 2013 than 2019:
