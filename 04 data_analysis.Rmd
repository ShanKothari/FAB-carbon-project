...
There is evidently a close relationship between soil moisture and macroaggregate fraction. Indeed, since the blocks vary in macroaggregate content, this model may shrink the parameter estimate.

How about pH? As it turns out, it isn't correlated with soil moisture but is correlated with macroaggregates.
